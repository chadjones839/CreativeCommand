...
export const CampaignStatusProvider = (props) => {
    ...
    return (
        <CampaignStatusContext.Provider value={{
            campaignStatus, campaignStatuses, getAllCampaignStatuses, getAllByCampaignAccountId, getByCampaignId, addCampaignStatus, updateCampaignStatus, deleteCampaignStatus, setCampaignStatus, getAllByCampaignId
        }}>
            {props.children}
